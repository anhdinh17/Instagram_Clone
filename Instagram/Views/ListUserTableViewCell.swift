...
//  Instagram
//
//  Created by Anh Dinh on 7/29/21.
//
...
//MARK: - Init
    ...
    override func layoutSubviews() {
        ...
        profilePictureImageView.frame = CGRect(x: 5,
                                               y: (contentView.height - size)/2, // center y
                                               width: size,
                                               height: size)
...
//MARK: - Functions
    ...
    public func configure(with viewModel: ListUserTableViewCellViewModel){
        ...
        StorageManager.shared.profilePictureURL(username: viewModel.username) { [weak self] url in
